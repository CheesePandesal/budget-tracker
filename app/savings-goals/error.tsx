...
export default function Error({
  ...
  useEffect(() => {
    ...
    console.error('Savings goals page error:', error);
  }, [error]);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <div className="flex items-center space-x-2 mb-2">
            ...
            <span className="text-sm font-medium text-primary">Savings Management</span>
          </div>
          <h1 className="text-3xl lg:text-4xl font-bold">Savings Goals</h1>
          <p className="text-muted-foreground mt-1">Set and track your family's financial goals</p>
        </div>
      </div>
      ...
      <Card className="border-destructive/20 shadow-xl">
        <CardHeader className="text-center pb-6">
          ...
          <CardDescription className="text-lg text-muted-foreground">
            We couldn't load your savings goals data. This might be a temporary issue.
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 pt-6 border-t border-border">
            ...
            <Card className="border-l-4 border-l-blue-500 opacity-50">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
            ...
            <Card className="border-l-4 border-l-violet-500 opacity-50">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                  ...
                  <div className="p-3 bg-violet-50 dark:bg-violet-950/20 rounded-full">
